                                        ...
                                        <div class="controls">
                                            <select name="brand_id" id="select" required class="form-control">
                                                ...
                                                @foreach ($brands as $brand)
                                                    <option {{$brand->id == $products->brand_id ? 'selected':''}} value="{{ $brand->id }}">{{ $brand->brand_name_en }}
                                                    </option>
                                                @endforeach
                                            </select>
                                            @error('category_id')
                                        ...
                                        <div class="controls">
                                            <select name="category_id" id="select" required class="form-control">
                                                ...
                                                @foreach ($categories as $category)
                                                    <option {{$category->id == $products->category_id ? 'selected':''}} value="{{ $category->id }}">{{ $category->category_name_en }}
                                                    </option>
                                                @endforeach
                                            </select>
                                            @error('category_id')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <select name="subcategory_id" id="select" required class="form-control">
                                                ...
                                                <option {{$subcategory->id == $products->subcategory_id ? 'selected':''}} value="{{ $subcategory->id }}">{{ $subcategory->subcategory_name_en }}</option>
                                                @endforeach
                                            </select>
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <select name="subsubcategory_id" id="select" required class="form-control">
                                                ...
                                                <option {{$subsubcategory->id == $products->subsubcategory_id ? 'selected':''}} value="">{{$subsubcategory->subsubcategory_name_en}}</option>
                                                @endforeach
                                            </select>
                                            @error('category_id')
                                                <span class="text-danger">{{ $message }}</span>
                                ...
                                <div class="col-4">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" value="{{$products->product_name_en}}" name="product_name_en"
                                ...
                                <div class="col-4">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" value="{{ $products->product_name_uz }}" name="product_name_uz"
                                                class="form-control unicase-form-control text-input">
                            ...
                            <div class="row">
                                <div class="col-4">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" value="{{$products->product_qty}}" name="product_qty"
                                                class="form-control unicase-form-control text-input">
                                            @error('product_qty')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <div class="input-group">
                                                <input type="text" value="{{$products->product_tags_en}}" name="product_tags_en" value=""
                                ...
                                <div class="col-4">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <div class="input-group">
                                                <input type="text" value="{{$products->product_tags_uz}}" name="product_tags_uz" value=""
                                                    data-role="tagsinput" placeholder="turkum qo'shing">
                                            </div>
                            ...
                            <div class="row">
                                <div class="col-4">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" value="{{$products->product_size_en}}" name="product_size_en"
                                                class="form-control unicase-form-control text-input">
                                ...
                                <div class="col-4">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" value="{{$products->product_size_uz}}" name="product_size_uz"
                                                class="form-control unicase-form-control text-input">
                                ...
                                <div class="col-4">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <div class="input-group">
                                                <input type="text" value="{{$products->product_color_en}}" name="product_color_en" value=""
                            ...
                            <div class="row">
                                <div class="col-4">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <div class="input-group">
                                                <input type="text" value="{{$products->product_color_uz}}" name="product_color_uz" value=""
                                                    data-role="tagsinput" placeholder="ranglar qo'shing">
                                            </div>
                                ...
                                <div class="col-4">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" value="{{$products->selling_price}}" name="selling_price"
                                                class="form-control unicase-form-control text-input">
                                            @error('selling_price')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                ...
                                <div class="col-4">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" value="{{$products->discount_price}}" name="discount_price"
                                                class="form-control unicase-form-control text-input">
                            ...
                            <div class="row">
                                ...
                                <div class="col-4">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" value="{{$products->product_code}}" name="product_code"
                                                class="form-control unicase-form-control text-input">
                                            @error('product_code')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    ...
                                    <textarea class="form-control" placeholder="izoh kiriting" name="short_descp_uz" id="" cols="30"
                                        rows="5">{{$products->short_descp_uz}}</textarea>
